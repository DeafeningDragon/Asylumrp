...
Config.UsingNewQBInv = true -- if you using latest qbcore inventory versions, set to true
...
Config.Tiers = {
    ...
    ["Josives House"] = {
        doorCoords = vector4(-1664.14,462.9,130.31,30.78), -- see cameras interaction zone  am i able to add more doors here?
        defaultStash = vector3(-1671.71,429.92,135.1), -- default stash interaction zone
        defaultWardrobe = vector3(-1680.06, 435.29, 135.13), -- default wardrobe interaction zone
        defaultLogout = vector3(-1672.95,455.98,130.31), -- default logout interaction zone
        managementCoords = vector3(-1665.33, 448.62, 130.35), -- default management interaction zone
        fridge = {coords = vector4(-1681.2, 436.85, 130.32,103.41), fridgeItems = {interactions = {"beer", "soda", "champagne"}, interactionsCommands = {"e beer", "e soda", "e champagne"}}, label = "frigorifico"}, -- default fridge animations zone
        previewImage = nil, -- can leave nil ONLY ON MLOs
        isMLO = true, -- NEVER CHANGE THIS if you are creating a new MLO
    },
    ["BooksHouse"] = {
        doorCoords = vector4(-661.41, 944.77, 244.09, 88.99), -- see cameras interaction zone
        defaultStash = vector3(179.88, 1714.64, 227.39), -- default stash interaction zone
        defaultWardrobe = vector3(180.53, 1715.38, 231.08), -- default wardrobe interaction zone
        defaultLogout = vector3(-659.89, 944.74, 244.09), -- default logout interaction zone
        managementCoords = vector3(-641.68, 949.33, 243.95), -- default management interaction zone
        fridge = {coords = vector4(-659.65, 947.34, 243.95, 177.16), fridgeItems = {interactions = {"beer", "soda", "champagne"}, interactionsCommands = {"e beer", "e soda", "e champagne"}}, label = "frigorifico"}, -- default fridge animations zone
        previewImage = nil, -- can leave nil ONLY ON MLOs
        isMLO = true, -- NEVER CHANGE THIS if you are creating a new MLO
    },
    ["Saras House"] = {
        doorCoords = vector4(180.34, 1711.01, 227.39, 92.32), -- see cameras interaction zone  am i able to add more doors here?
        defaultStash = vector3(183.64, 1704.81, 231.07), -- default stash interaction zone
        defaultWardrobe = vector3(180.53, 1715.38, 231.08), -- default wardrobe interaction zone
        defaultLogout = vector3(187.24,1717.64,231.08), -- default logout interaction zone
        managementCoords = vector3(189.19,1713.31,231.07), -- default management interaction zone
        fridge = {coords = vector4(187.74,1703.95,227.39,179.95), fridgeItems = {interactions = {"beer", "soda", "champagne"}, interactionsCommands = {"e beer", "e soda", "e champagne"}}, label = "frigorifico"}, -- default fridge animations zone
        previewImage = nil, -- can leave nil ONLY ON MLOs
        isMLO = true, -- NEVER CHANGE THIS if you are creating a new MLO
    },
    ["killien House"] = {
        doorCoords = vector4(1408.37, 4712.33, 134.84, 281.74), -- see cameras interaction zone  am i able to add more doors here?
        defaultStash = vector3(1405.47, 4718.93, 134.84), -- default stash interaction zone
        defaultWardrobe = vector3(1416.95,4718.33,140.24), -- default wardrobe interaction zone
        defaultLogout = vector3(187.24,1717.64,231.08), -- default logout interaction zone
        managementCoords = vector3(1416.39,4723.3,140.26), -- default management interaction zone
        fridge = {coords = vector4(1375.39,4709.05,134.84,102.7), fridgeItems = {interactions = {"beer", "soda", "champagne"}, interactionsCommands = {"e beer", "e soda", "e champagne"}}, label = "frigorifico"}, -- default fridge animations zone
        previewImage = nil, -- can leave nil ONLY ON MLOs
        isMLO = true, -- NEVER CHANGE THIS if you are creating a new MLO
    },
    -- shells
    ...
    ["CaravanShell"] = {
        doorCoords = vector4(3.3, -2.1, -1.4, 358.633972), -- "offsets"
        defaultStash = vector3(0.0, 0.0, 0.0), -- auto generated
        defaultWardrobe = vector3(0.0, 0.0, 0.0), -- auto generated
        defaultLogout = vector3(0.0, 0.0, 0.0), -- auto generated
        managementCoords = vector3(0.0, 0.0, 0.0), -- auto generated
...
Config.Houses = {
    ...
    ["Josives House"] = { -- House name, MUST BE UNIQUE OTHER WISE WILL HAVE ERRORS
        houseName = "Josives House", -- House name, MUST BE UNIQUE OTHER WISE WILL HAVE ERRORS
        price = 1500, -- House price
        maxFurnitureRange = 1000,
        doorCoords = vector4(-1666.0, 463.47, 130.31, 202.58), -- House door coords this is that door
        doorInside = Config.Tiers["Josives House"], -- House inside infos
        houseGarage = {
            enabled = true, -- House garage enabled ?
            coords = vector3(-1681.81, 452.74, 130.31), -- House garage door
            doorInside = Config.Tiers["neonGarage"], -- House garage inside infos
            storeCar = vector3(-1687.22, 473.5, 130.28), -- House garage car storage
            spawnCar = vector4(-1681.77, 470.72, 130.28, 31.0), -- House garage car spawn
        },
        stars = 5, -- House rating
        pool = true, -- House have a pool?
        garden = true, -- House have a garden?
        ...
        canVisit = true, -- House can be visited?
        stashLevel = 1, -- What level is default level of stash?
        stashName = "Josives House", -- Stash name, must be unique, if same name houses can share their stash
        mlo = true, -- is it a MLO?
        description = "Modern House with pool, garen, camara system and visiting options! Cheap!" -- House description
    },
    ["Saras House"] = { -- House name, MUST BE UNIQUE OTHER WISE WILL HAVE ERRORS
        houseName = "Saras House", -- House name, MUST BE UNIQUE OTHER WISE WILL HAVE ERRORS
        price = 1500, -- House price
        maxFurnitureRange = 1000,
        doorCoords = vector4(177.77, 1700.56, 227.39, 358.46), -- House door coords this is that door
        doorInside = Config.Tiers["Saras House"], -- House inside infos
        houseGarage = {
            enabled = true, -- House garage enabled ?
            coords = vector3(172.65, 1702.44, 227.39), -- House garage door
            doorInside = Config.Tiers["neonGarage"], -- House garage inside infos
            storeCar = vector3(169.63, 1700.27, 227.39), -- House garage car storage
            spawnCar = vector4(169.3, 1689.58, 227.72, 201.81), -- House garage car spawn
        },
        stars = 5, -- House rating
        pool = true, -- House have a pool?
        garden = true, -- House have a garden?
        ...
        canVisit = true, -- House can be visited?
        stashLevel = 1, -- What level is default level of stash?
        stashName = "Saras House", -- Stash name, must be unique, if same name houses can share their stash
        mlo = true, -- is it a MLO?
        description = "Modern House with pool, garen, camara system and visiting options! Cheap!" -- House description
    },
    ["killien House"] = { -- House name, MUST BE UNIQUE OTHER WISE WILL HAVE ERRORS
        houseName = "killien House", -- House name, MUST BE UNIQUE OTHER WISE WILL HAVE ERRORS
        price = 1500, -- House price
        maxFurnitureRange = 1000,
        doorCoords = vector4(1406.94, 4723.33, 134.84, 197.55), -- House door coords this is that door
        doorInside = Config.Tiers["killien House"], -- House inside infos
        houseGarage = {
            enabled = true, -- House garage enabled ?
            coords = vector3(172.65, 1702.44, 227.39), -- House garage door
            doorInside = Config.Tiers["neonGarage"], -- House garage inside infos
        ...
        canVisit = true, -- House can be visited?
        stashLevel = 1, -- What level is default level of stash?
        stashName = "killien House", -- Stash name, must be unique, if same name houses can share their stash
        mlo = true, -- is it a MLO?
        description = "Modern House with pool, garen, camara system and visiting options! Cheap!" -- House description
    },
}

...
Config.Products = {
    ...
    ['weedshop'] = {
        ...
        { name = 'weed_whitewidow',          price = 15,  amount = 150 },
        { name = 'weed_skunk', price = 21, amount = 50 },
        { name = 'weed_purplehaze', price = 20,  amount = 50 },
        { name = 'weed_ogkush', price = 25,   amount = 1000 },
        { name = 'weed_amnesia',  price = 28,   amount = 1000 },
{ name = 'weed_whitewidow_seed',  price = 50,   amount = 10 },
{ name = 'weed_skunk_seed',  price = 32,   amount = 5 },
{ name = 'weed_purplehaze_seed',  price = 82,   amount = 20 },
{ name = 'weed_ogkush_seed',  price = 29,   amount = 8 },
{ name = 'weed_amnesia_seed',  price = 50,   amount = 11 },
{ name = 'meth',  price = 120,   amount = 2 },
{ name = 'cokebaggy',  price = 80,   amount = 1 },
    ...
    ['blackmarket'] = {
        ...
        { name = 'lockpick',         price = 50, amount = 50 },
...
Config.Locations = {
    ...
    ['weedshop2'] = {
        ['label'] = 'Smokey Joe Dealer',
        ['coords'] = vector4(1289.17, -1710.68, 55.48, 202.95),
        ['ped'] = 'a_m_y_hippy_01',
        ['scenario'] = 'WORLD_HUMAN_AA_SMOKE',
        ['targetIcon'] = 'fas fa-cannabis',
        ['targetLabel'] = 'Open Weed Shop',
    ...
    ['blackmarket'] = {
        ['label'] = 'Black Market',
        ['coords'] = vector4(-428.68, -1728.3, 19.78, 72.02),

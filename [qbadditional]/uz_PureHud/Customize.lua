Customize = {
    ...
    DisableJobsStress = { 'police', 'marshal', 'ambulance'}, -- Add here jobs you want to disable stress - OLD: -- DisablePoliceStress = true, -- If true will disable stress for people with the police job

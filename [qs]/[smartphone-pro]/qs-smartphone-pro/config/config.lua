...
--[[
    Maximum number of posts, messages, etc. that can be fetched from the server.

    Since we use virtualize, the ui will always be stable. But your sql usage will increase.
    NOTE: virtualize is only available for instagram and messages. It'll be added to other apps in the future.
]]
...
Config.Billing = dependencyCheck(billing) or 'standalone'
...
Config.Inventory = Config.Framework == 'standalone' and 'default' or Config.Inventory
Config.UniquePhone = Config.Inventory ~= 'default' and Config.Framework ~= 'standalone'
...
Config.DefaultMetaData = {
    blur_disabled = true, -- If you use false, it will look nicer, but there are people with pc potato who will find it complicated
    lockscreen    = true
}

Config.Houses = dependencyCheck(houses) or 'default'
...
Config.Garage = dependencyCheck(garages) or 'default'
...
Config.Vehiclekeys = dependencyCheck(keys) or 'none'

Config.Valet = true                                   -- Enable or disable the valet system
Config.ValetPrice = 1000                              -- Price that the valet will charge

Config.VehicleShopLocation = -33.784615, -1102.021973 -- Just put the x,y value. Remember that it is a SetWayPoint, do not put the z (this is the location of the iCar app button)
...
Config.PhoneApplications = {
    ...
    },
    {
        ...
        label = 'ACRP',
        game = {
            iframe = 'https://deafeningdragon.wixsite.com/asylumrp',
            rotate = false,
            name = 'ACRP',
            css = {
                top = '0',
...
Config.DeleteNotificationsAutomatically = false -- Delete notifications automatically after a certain time set false to disable (DEFAULT: 5 * 60 * 60 * 1000)

...
RegisterNetEvent('strez:raisewater', function()
    CreateThread(function()
        ...
        local maxFloodHeight = 70 -- Change this value to set the maximum flood height

        local increaseRate = 02 -- Change this value to increase/decrease the rate at which the water height changes

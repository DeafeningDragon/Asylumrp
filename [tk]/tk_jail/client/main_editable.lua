...
function RevivePlayer()
    TriggerEvent('esx_ambulancejob:revive') -- Change this to correspond to your servers revive event if you use something else than esx_ambulancejob
end
...
function ChangeClothes(changeType)
    ...
    if changeType == 'unjail' then
        TriggerCallback('esx_skin:getPlayerSkin', function(skin)
...
function OxOpenTasksMenu(oldTask, taskData)
    ...
    if Config.DebugMode then print('open task menu', oldTask, taskData, json.encode(elements)) end

...
Config.Phone = 'qs' -- default/lb/qs/gks/gks2/high/yseries -- you can add your own in server/main_editable.lua
Config.Housing = 'JPR' -- tk/ps/loaf/qb/qbx/qs/cylex/nolag/bcs -- you can add your own in server/main_editable.lua
Config.Dispatch = 'tk' -- tk/cd/qs/ps/core/rcore -- see server/main_editable.lua for examples on how to add your own
Config.Jail = 'tk' -- tk/pickle/rcore -- see client/main_editable.lua for examples on how to add your own
...
Config.Images = { -- allows you to define custom images for each MDT, if not set will just use default text instead (like "Police")
    --police = '',
    --ems = '',
    --citizen = '',
}
...
Config.Jobs = {
    police = {
        police = 12, -- job name, boss minimum grade
        marshal =12,--sheriff = 5, -- you can add multiple jobs
    },
    ambulance = {
        ambulance = 3,
    }
...
Config.TrainingReports = {
    police = {
        minGrade = 2, -- minimum grade to create a training report
...
Config.NeedItemCommand = true -- true / false, should player need the item to use the command

Config.Coords = { -- coords for police report and citizen mdt, remove if you dont want to use
    policeReport = {
        {coords = vec4(441.1595, -978.8431, 30.6896, 178.8787), dist = 3.0, ped = `s_f_y_cop_01`, scenario = 'WORLD_HUMAN_COP_IDLES'},
    },
    citizenMDT = {
...
Config.PolicePages = {'home', 'profiles', 'vehicles', 'properties', 'businesses', 'incidents', 'reports', 'trainingReports', 'policeReports', 'evidence', 'weapons', 'map', 'charges', 'legislation', 'employees'}
Config.EMSPages = {'home', 'profiles', 'reports', 'trainingReports', 'map', 'employees'}
Config.CitizenPages = {'profiles', 'charges', 'legislation', 'reports', 'incidents'}
...
Config.LicensePointsDuration = 365 -- days (remove if you dont want to use)
